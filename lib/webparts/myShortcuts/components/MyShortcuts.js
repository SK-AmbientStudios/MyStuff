...
import styles from './MyShortcuts.module.scss';
...
var MyShortcuts = /** @class */ (function (_super) {
    ...
    MyShortcuts.prototype.render = function () {
        ...
        return (React.createElement("section", { className: "".concat(styles.myShortcuts, " ").concat(hasTeamsContext ? styles.teams : '') },
...
//# sourceMappingURL=MyShortcuts.js.map